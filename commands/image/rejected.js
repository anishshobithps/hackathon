...
let image = message.mentions.users.first() ? message.mentions.users.first().displayAvatarURL({format: 'png', size: 512}) :message.author.displayAvatarURL({format: 'png', size: 512});
   try {
    const base = await loadImage("https://raw.githubusercontent.com/dragonfire535/xiao/master/assets/images/rejected.png");
    ...
    ctx.drawImage(base, x, y, width, height);
        const attachment = new Discord.MessageAttachment(canvas.toBuffer(), 'rejected.png');
...
module.exports.help = {
    name: "rejected",
		category: "Image",
		description: "Shows rejected image manipulation"
};